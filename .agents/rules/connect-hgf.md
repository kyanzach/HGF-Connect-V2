...
trigger: always_on
glob:
description: HGF Connect project-specific rules — architecture, deployment, UI patterns, and gotchas
---

# HGF Connect — Project Rules
...
### Confirmed Modal Pattern (ConfirmModal)
